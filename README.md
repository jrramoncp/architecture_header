...
![Captura de pantalla del proyecto](/public/img/screenshots/screenshoot.png)



## Descripción

Este proyecto consiste en un header para un estudio de arquitectura. Está enfocado unicamente en diseño. Por el momento no es responsive y unicamente tienen interactividad los enlaces del nav y el boton que tienen un efecto para cuando hacemos hover sobre ellos. 
...
1. **Clona este repositorio:**
   ```sh
   git clone https://github.com/jrramoncp/architecture_header
   cd architecture_header
   ```
...
También se encuentra desplegado en [GitHub Pages](https://jrramoncp.github.io/architecture_header/)
